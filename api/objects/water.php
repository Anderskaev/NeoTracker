...
class Water {
    ...
    function show_all($param) {
        ...
        $sql = " SELECT sum(ifnull(s.amount,0)) cnt from water s WHERE s.telegram_id = ? $ssuf";        
